...
export class AdminServicesService {
  ...
  async getServices(filters?: {
    ...
    const response = await axios.get<{
      ...
      page: number;
      totalPages: number;
    }>(`${API_BASE_URL}/api/admin/services?${params.toString()}`, this.getAuthHeader());
    return response.data;
  }

  async getServiceStats() {
    const response = await axios.get(`${API_BASE_URL}/api/admin/services/stats`, this.getAuthHeader());
    return response.data;
  }
  ...
  async assignTechnician(
    ...
    const response = await axios.put(
      `${API_BASE_URL}/api/admin/services/${serviceId}/assign-technician`,
      data,
      this.getAuthHeader()
    );
    return response.data;
  ...
  async changeTechnician(serviceId: string, data: { technicianId: string; reason?: string }) {
    const response = await axios.put(
      `${API_BASE_URL}/api/admin/services/${serviceId}/change-technician`,
      data,
      this.getAuthHeader()
    );
    return response.data;
  ...
  async updateServiceStatus(serviceId: string, data: { status: string; notes?: string }) {
    const response = await axios.put(
      `${API_BASE_URL}/api/admin/services/${serviceId}/status`,
      data,
      this.getAuthHeader()
    );
    return response.data;
  ...
  async updateServiceCost(serviceId: string, data: { estimatedCost: number; notes?: string }) {
    const response = await axios.put(
      `${API_BASE_URL}/api/admin/services/${serviceId}/cost`,
      data,
      this.getAuthHeader()
    );
    return response.data;
  ...
  async completeService(serviceId: string, data: { finalCost: number; notes?: string }) {
    const response = await axios.put(
      `${API_BASE_URL}/api/admin/services/${serviceId}/complete`,
      data,
      this.getAuthHeader()
    );
    return response.data;
  ...
  async getTechnicians(filters?: {
    ...
    const response = await axios.get<{
      ...
      page: number;
      totalPages: number;
    }>(`${API_BASE_URL}/api/admin/technicians?${params.toString()}`, this.getAuthHeader());
    return response.data;
  }

  async getTechnicianStats() {
    const response = await axios.get(
      `${API_BASE_URL}/api/admin/technicians/stats`,
      this.getAuthHeader()
    );
    return response.data;
  }
  ...
  async getAvailableTechnicians(specialization: string) {
    const response = await axios.get<Technician[]>(
      `${API_BASE_URL}/api/admin/technicians/available/${specialization}`,
      this.getAuthHeader()
    );
    return response.data;
  }
  ...
  async createTechnician(data: Partial<Technician>) {
    const response = await axios.post(`${API_BASE_URL}/api/admin/technicians`, data, this.getAuthHeader());
    return response.data;
  }

  async updateTechnician(id: string, data: Partial<Technician>) {
    const response = await axios.put(
      `${API_BASE_URL}/api/admin/technicians/${id}`,
      data,
      this.getAuthHeader()
    );
    return response.data;
  ...
  async updateTechnicianStatus(id: string, status: string) {
    const response = await axios.put(
      `${API_BASE_URL}/api/admin/technicians/${id}/status`,
      { status },
      this.getAuthHeader()
    );
    return response.data;
  ...
  async getAppointments(filters?: {
    ...
    const response = await axios.get<{
      ...
      page: number;
      totalPages: number;
    }>(`${API_BASE_URL}/api/admin/appointments?${params.toString()}`, this.getAuthHeader());
    return response.data;
  }

  async getAppointmentStats() {
    const response = await axios.get(
      `${API_BASE_URL}/api/admin/appointments/stats`,
      this.getAuthHeader()
    );
    return response.data;
  }
  ...
  async assignAgent(id: string, agentId: string) {
    const response = await axios.put(
      `${API_BASE_URL}/api/admin/appointments/${id}/assign-agent`,
      { agentId },
      this.getAuthHeader()
    );
    return response.data;
